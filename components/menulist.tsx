  ...
  return (
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="flex flex-col p-0 items-center mt-4 border border-gray-100 bg-transparent rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="https://github.com/paanjoe/ustazgpt/issues"
            target={"_blank"} 
            className="block py-2 pl-4 pr-4 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition-all hover:delay-100  text-gray-900 dark:text-white">Report a Bug</a>
        </li>
        <li>
          <a href="https://github.com/paanjoe/ustazgpt"
            target={"_blank"} 
            className="block py-2 pl-3 pr-4  rounded bg-transparent  hover:bg-gray-200  dark:hover:bg-gray-700 transition-all hover:delay-100 text-gray-900 dark:text-white">GitHub</a>
        </li>
        <li>
          <a href="https://www.buymeacoffee.com/paanjoe"
            target={"_blank"} 
            className="block py-2 pl-3 pr-4 rounded bg-transparent  hover:bg-gray-200 dark:hover:bg-gray-700 transition-all hover:delay-100  text-gray-900 dark:text-white">Sponsor</a>
        </li>
        <li>
        {colorTheme === "light" ? (
